...
{
    public class MemoryCacheClient : ICacheClientExtended
    {
        private readonly ILogger<MemoryCacheClient> Log;
        ...
        public MemoryCacheClient(ILogger<MemoryCacheClient> LogAutoWire)
        {
        ...
        public void RemoveAll(IEnumerable<string> keys)
        {
            foreach (var key in keys)
            {
                ...
                {
                    Log.LogError($"Error trying to remove {key} from the cache", ex);
                }
            }
        }
        ...
        public void RemoveByRegex(string pattern)
        {
            ...
            using (var enumerator = this.memory.GetEnumerator())
            {
                ...
                {
                    Log.LogError($"Error trying to remove items from cache with this {pattern} pattern", ex);
                }
            }
        }
